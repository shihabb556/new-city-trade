      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-surface-container-low p-10 rounded-xl space-y-4 relative overflow-hidden group">
            ...
            <h3 className="text-md sm:text-lg md:text-xl font-headline font-bold text-primary">Our Mission</h3>
          ...
          <div className="bg-primary p-10 rounded-xl space-y-4 relative overflow-hidden group">
            ...
            <h3 className="text-md sm:text-lg md:text-xl font-headline font-bold text-white">Our Vision</h3>
            <p className="text-xs sm:text-sm md:text-base text-surface-variant leading-relaxed">
