    ...
    <section className="py-24 bg-surface overflow-hidden">
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <h3 className="text-4xl font-headline font-bold text-primary">What Our Clients Say</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div className="bg-surface-container-low p-8 rounded-xl relative">
            ...
            <p className="text-lg text-primary font-medium leading-relaxed mb-6 italic">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-primary">Project Lead</p>
                <p className="text-sm text-secondary">Elite Real Estate Group</p>
              </div>
            </div>
          </div>
          <div className="bg-surface-container-low p-8 rounded-xl relative">
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-slate-300"></div>
              <div>
                <p className="font-bold text-primary">Operations Head</p>
                <p className="text-sm text-secondary">Dhaka Construction Hub</p>
              </div>
            </div>
          </div>
        </div>
        <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
          <span className="text-3xl font-black text-primary font-headline">SHANTA</span>
          <span className="text-3xl font-black text-primary font-headline">CONCORD</span>
          <span className="text-3xl font-black text-primary font-headline">NAVANA</span>
          <span className="text-3xl font-black text-primary font-headline">ASSURANCE</span>
          <span className="text-3xl font-black text-primary font-headline">BUILDING</span>
        </div>
      </div>
    </section>
  );
