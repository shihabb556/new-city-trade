      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-on-tertiary-container font-label">
              About NCT Bangladesh
            </h2>
            <h3 className="text-md sm:text-lg md:text-xl font-headline font-bold text-primary leading-tight">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8">
              <div className="p-6 bg-surface-container-lowest rounded-xl shadow-sm">
                <span className="block text-sm sm:text-base md:text-lg font-extrabold text-primary mb-1">500+</span>
              ...
              <div className="p-6 bg-surface-container-lowest rounded-xl shadow-sm">
                <span className="block text-sm sm:text-base md:text-lg font-extrabold text-primary mb-1">1000+</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4 pt-12">
              ...
              <div className="bg-primary p-6 rounded-xl text-white">
                <p className="text-xs sm:text-sm md:text-base italic font-light">
